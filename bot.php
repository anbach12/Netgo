...
switch ($tlg->Text ()){
	...
	$tlg->sendMessage ([
		...
		'reply_markup' => $tlg->buildInlineKeyBoard ([
			[$tlg->buildInlineKeyboardButton ('PRUEBA NETGO POR 24 HORAS', null, '/sshgratis')]
		])
	]);
	...
	$tlg->sendMessage ([
		'chat_id' => $tlg->ChatID (),
		'text' => 'Bot Mod @batmonn por @carnalminerdso'
	]);
	...
	if ($redis->dbSize () == $limite){
		...
		$textoSSH="Cuenta creada para NETGO VPN ;)\r\n\r\n<b>Servidor:</b> <code>".$ip."</code>\r\n<b>Usuario:</b> <code>".$usuario."</code>\r\n<b>Contraseña:</b> <code>".$senha."</code>\r\n<b>Logins:</b> 1\r\n<b>Valido:</b> ".date ('d/m', strtotime('+1 day'))."\r\n\r\n🤙 Cortesia de @anbach12";
